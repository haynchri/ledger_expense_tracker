...
class Account(models.Model):
    ...
    def recalculate_balance(self):
        ...
        self.balance = self.starting_balance + income - expense
...
class Reconciliation(models.Model):
    transaction_a = models.OneToOneField(
        Transaction, on_delete=models.CASCADE, related_name='reconciliation_a'
    )
    transaction_b = models.OneToOneField(
        Transaction, on_delete=models.CASCADE, related_name='reconciliation_b'
    )
    created_at = models.DateTimeField(auto_now_add=True)
    ...
    def __str__(self):
        return f'{self.transaction_a} ↔ {self.transaction_b}'
